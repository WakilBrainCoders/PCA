...
## Similar to PCA, used within the limma package. I haven't worked with MDS before, but my understanding is that it is similar to PCA but doesn't depend on linear relationships in the data.
